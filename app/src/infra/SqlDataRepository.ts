    ...
    `;
        ...
        const csvWriter = createObjectCsvWriter({
            ...
            header: [
                ...
                { id: 'function_stated', title: 'Article Designed For Function' },
