...
export default class SqlDataRepository implements IDataRepository {
    ...
    `;
        ...
        const csvWriter = createObjectCsvWriter({
            ...
            header: [
                ...
                { id: 'stim_amplitude_variable', title: 'Stimulation amplitude variable' },
                ...
                { id: 'stim_phase_length_multiple', title: 'Phase Length multiple' },
                ...
                { id: 'function_stated', title: 'Function stated' },
    ...
    private _insertNewResult(newResult: Result): void {
        ...
        this.db.prepare(stmt).run({
            ...
            stim_amplitude_variable: newResult.stimulation_parameters.amplitude_variable ? 1 : 0,
            ...
            stim_phase_length_multiple: newResult.stimulation_parameters.phase_length_multiple,
    ...
    private _editResult(resultId: number, newResult: Result): void {
        ...
        UPDATE Results SET 
            ...
            stim_amplitude_variable=@stim_amplitude_variable,
            stim_freq=@stim_freq,
            ...
            stim_phase_length_multiple=@stim_phase_length_multiple,
    ...
    private _createResultsTableIfNotExist() {
        const createStmt = `
            CREATE TABLE IF NOT EXISTS Results (
                ...
                stim_amp_ma_max REAL,
                stim_amp_ma_avg REAL,
                stim_amplitude_variable INTEGER,
                stim_freq INTEGER,
                stim_freq_max INTEGER,
                ...
                stim_contact_length INTEGER,
                stim_phase_length REAL,
                stim_phase_length_multiple TEXT,
                stim_phase_type TEXT,
                stim_epi_zone TEXT,
                stim_epi_zone_comments TEXT,
                effect_class TEXT,
