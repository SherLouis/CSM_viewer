...
export type ReadResultEntity = {
    ...
    stim_phase_length_multiple: string,
...
export const ReadResultEntityToModel = (readEntity: ReadResultEntity): Result => {
    return {
        ...
        stimulation_parameters: {
            ...
            duration_variable: readEntity.stim_duration_variable > 0,
            ...
            phase_length_multiple: readEntity.stim_phase_length_multiple,
